...
\tikzset{
  ...
  \node (wcc) [ssconsistency] {%\Large WCC\\
                             \red{$\hb\subseteq \vis$}\\
                             \teal{$\vis \subseteq \ar$}\\
                             \blue{$V[e] = \emptyset$}};
  \node (nwcc) [cn, below = 0.1cm of wcc] {\wcc};

  \node (cc) [sconsistency, above right=0.1cm and 0.5cm of wcc] {%\large CC\\
                             \red{$\hb \subseteq \vis$}\\
                             \teal{$\vis \subseteq \ar$}\\
                             \blue{$V[e] = \so^{-1}(e)$}};
  \node (ncc) [cn, below = 0.1cm of cc] {\cm};

  \node (ccv) [lconsistency, draw = red, very thick, right = 4.5cm of wcc] {%\large CCv\\
                             \red{$\hb \subseteq \vis$}\\
                             \teal{$\vis \subseteq \ar \wedge \tord{\ar,E}$}\\
                             \blue{$V[e]=\so^{-1}(e)$}};
  \node (nccv) [cn, below = 0.1cm of ccv] {\cmv};

  \node (scc) [sconsistency, above = 2.0cm of ccv] {%\large SCC\\
                             \red{$\hb \subseteq \vis$}\\
                            \teal{$\vis \subseteq \ar$}\\
                            \blue{$V[e] = \vis^{-1}(e)$}};
  ...
  \node (sccv) [lconsistency, right = 1.0cm of ccv] {%\large SCCv\\
                             \red{$\hb \subseteq \vis$}\\
                            \teal{$\vis \subseteq \ar \wedge \tord{\ar,E}$}\\
                            \blue{$V[e] = \vis^{-1}(e)$}};
  \node (nsccv) [cn, below = 0.1cm of sccv] {\sccv};

  \node (wccv) [lconsistency,below right=1.5cm and 1.0cm of wcc] {%\large WCCv\\
                             \red{$\hb \subseteq \vis$}\\
                             \teal{$\vis \subseteq \ar \wedge \tord{\ar,E}$}\\
                             \blue{$V[e] =\emptyset$}};
