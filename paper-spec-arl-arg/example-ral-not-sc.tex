...
\tikzset{
  ...
  \node (p1-deq3) [deq-op, right = 1.6cm of p1-deq1] {\texttt{Deq/3}};

  \node (p2) [process, below = 1.4cm of p1] {$p_2:$};
  \node (p2-enq2) [enq-op, right = 0.5cm of p2] {\texttt{Enq(2)}};
  \node (p2-enq3) [enq-op, right = 1.6 of p2-enq2] {\texttt{Enq(3)}};

  \draw [po] (p1-enq1) to (p1-deq1);
  \draw [po] (p1-deq1) to (p1-deq3);
  \draw [po] (p2-enq2) to (p2-enq3);

  \draw [vis] (p2-enq3) to (p1-deq3);
