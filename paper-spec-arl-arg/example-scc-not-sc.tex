...
\tikzset{
  ...
  \node (p1-deq2) [deq-op, right = 1.6cm of p1-enq1] {\texttt{Deq/2}};

  \node (p2) [process, below = 1.4cm of p1] {$p_2:$};
  \node (p2-enq2) [enq-op, right = 0.5cm of p2] {\texttt{Enq(2)}};
  \node (p2-deq1) [deq-op, right = 1.6 of p2-enq2] {\texttt{Deq/1}};
  \node (p2-deq0) [deq-op, right = 1.6 of p2-deq1] {\texttt{Deq/$\perp$}};
   

  \draw [po] (p1-enq1) to (p1-deq2);
  \draw [po] (p2-enq2) to (p2-deq1);
  \draw [po] (p2-deq1) to (p2-deq0);

  \draw [vis] (p1-enq1) to (p2-deq1);
  \draw [vis] (p2-enq2) to (p1-deq2);
  \draw [vis] (p1-deq2) to (p2-deq0);
