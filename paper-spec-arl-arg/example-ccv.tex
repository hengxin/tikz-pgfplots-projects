...
\tikzset{
  ...
  \node (p2-deq1) [deq-op, right = 3.6cm of p2] {\texttt{Deq/1}};
  \node (p2-deq2) [deq-op, right = 2cm of p2-deq1] {\texttt{Deq/2}};

  \draw [po] (p1-enq1) to (p1-enq2);
  \draw [po] (p1-enq2) to (p1-deq2);

  \draw [po] (p2-deq1) to (p2-deq2);

  \draw [vis] (p1-enq1) to (p2-deq1);
  \draw [vis] (p2-deq1) to (p1-deq2);
