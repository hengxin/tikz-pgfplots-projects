...
\begin{tikzpicture}[fnode/.style = {fill = purple!40, rectangle, rounded corners, inner sep = 5pt, minimum width = 2.0cm, align = center},
  ...
  \node (semantics) [fnode, above = 1.5cm of mechanism.west, anchor = west] {Semantics: {\small PRAM}};
  \node (measurement) [fnode, below = 1.5cm of mechanism.west, anchor = west] {Measurement: {\small verify}};
