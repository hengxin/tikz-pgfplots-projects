% File: jupiter-css-podc16-c1324.tex
% CSS state space of client c2 for the schedule of jupiter-schedule-podc16.tex
...
\begin{tikzpicture}[css/.style = {font = \LARGE, rectangle, draw, very thick},
  ...
  \begin{scope}
    ...
    \begin{pgfonlayer}{background}
      \node (ss) [css, left = of 0.center, xshift = 6pt] {CSS$_{c_2}^{0}$};
      \node () [fit = (0) (ss), bg] {};
    \end{pgfonlayer}
  \end{scope}
  ...
  \begin{scope}[yshift = -2.5cm]
    ...
    \begin{pgfonlayer}{background}
      \node (ss) [css, left = of 0.center, xshift = 6pt] {CSS$_{c_2}^{1}$};
      \node () [fit = (0) (1) (ss), bg] {};
    \end{pgfonlayer}
  \end{scope}
  ...
  \begin{scope}[xshift = 3.5cm]
    ...
    \begin{pgfonlayer}{background}
      \node (ss) [css, right = of 0.center, xshift = 6pt] {CSS$_{c_2}^{2}$};
      \node () [fit = (0) (1) (13) (ss), bg] {};
    \end{pgfonlayer}
  \end{scope}
  ...
  \begin{scope}[yshift = -8.7cm]
    ...
    \begin{pgfonlayer}{background}
      \node (ss) [css, left = of 0.center, xshift = 6pt] {CSS$_{c_2}^{3}$};
  ...
  \begin{scope}[yshift = -19.7cm]
    ...
    \begin{pgfonlayer}{background}
      \node (ss) [css, left = of 0.center, xshift = 6pt] {CSS$_{c_2}^{4}$};
