...
\begin{tikzpicture}[timeline/.style = {very thick}, >=Stealth]
  ...
  \node (o1) [above left = -0.15cm and -0.40cm of 1] {ins$(x,0)$};
  \ssend{c2}{0.15}{0.25}{1}
  \ssend{c3}{0.15}{0.20}{1}

  \csend{c1}{0.30}{0.35}{2}
  \node (o2) [above left = -0.15cm and -0.40cm of 2] {del$(0)$};
  \ssend{c2}{0.35}{0.65}{2}
  \ssend{c3}{0.35}{0.70}{2}

  \csend{c2}{0.40}{0.55}{3}
  \node (o3) [above left = -0.15cm and -0.40cm of 3] {ins$(a,0)$};
  \ssend{c1}{0.55}{0.60}{3}
  \ssend{c3}{0.55}{0.90}{3}

  \csend{c3}{0.50}{0.75}{4}
  \node (o4) [above left = -0.15cm and -0.40cm of 4] {ins$(b,1)$};
