% File: jupiter-css-c3o3-c312.tex
...
\begin{tikzpicture}[css/.style = {font = \LARGE, rectangle, draw, very thick},
  ...
  \begin{scope}
	...
	\begin{pgfonlayer}{background}
	  \node (ss) [right = of 0.center, css] {CSS$_{c_3}^{0}$};
	  \node () [fit = (0) (ss), bg] {};
	\end{pgfonlayer}
  \end{scope}
  ...
  \begin{scope}[yshift = -1.6cm]
	...
	\begin{pgfonlayer}{background}
	  \node (ss) [above = of 3, css, xshift = -10pt] {CSS$_{c_3}^{1}$};
	  \node () [fit = (0) (3) (ss), bg] {};
	\end{pgfonlayer}
  \end{scope}
  ...
  \begin{scope}[yshift = -5.4cm]
	...
	\begin{pgfonlayer}{background}
	  \node (ss) [above = of 3, css, xshift = -10pt] {CSS$_{c_3}^{2}$};
	  \node () [fit = (0) (1) (3) (13) (ss), bg] {};
	\end{pgfonlayer}
  \end{scope}
  ...
  \begin{scope}[shift = {(0, -11)}]
	...
	\begin{pgfonlayer}{background}
	  \node (ss) [above = of 3, css, xshift = -10pt] {CSS$_{c_3}^{3}$};
