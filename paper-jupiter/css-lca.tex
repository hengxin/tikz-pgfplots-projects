...
\begin{tikzpicture}[p1/.style = {red, very thick},
  ...
  \state{s}{}{$\sigma$}
  \state{s'}{above right = 0.8cm and 1.5cm of s}{$\sigma'$}
  \state{s1}{below left = 2.5cm and 0.2cm of s}{$\sigma_1$}

  \state{sl'}{below right = 1.0cm and 0.5cm of s'}{$\sigma'_{L}$}
  \state{sx}{below left = 0.5cm and 0.2cm of sl'}{}
  \state{sy}{below left = 0.5cm and 0.2cm of sx}{$\sigma_{L}$}
  ...
  \state{sz'}{below right = 0.5cm and 1.0cm of sz}{$\sigma_2$}
