...
\begin{tikzpicture}[
  ...
  \draw[send, red, thick] ($(r2)!0.25!(r2bot)$) node[op, red] (del) {$o_2 = \del{e}{5}$} to ($(r1)!0.75!(r1bot)$) node[op, red] () {$o_2' = \del{e}{6}$};

  \node (r11) [list] at ($(r1)!0.50!(r1bot)$) {effecte};
  \node (r12) [list, fill = red!50] at ($(r1)!0.90!(r1bot)$) {effect};
