...
\begin{tikzpicture}[css/.style = {font = \LARGE, rectangle, draw, very thick},
  ...
  \begin{scope}
	...
	\begin{pgfonlayer}{background}
	  \node (ss) [css, left = of 0.center, xshift = 10pt] {CSS$_{c_1}^{0}$};
	  \node () [fit = (0) (ss), bg] {};
	\end{pgfonlayer}
  \end{scope}
  ...
  \begin{scope}[yshift = -1.6cm]
	...
	\begin{pgfonlayer}{background}
	  \node (ss) [css, above = of 1, xshift = 8pt] {CSS$_{c_1}^{1}$};
	  \node () [fit = (0) (1) (ss), bg] {};
	\end{pgfonlayer}
  \end{scope}
  ...
  \begin{scope}[yshift = -5.4cm]
	...
	\begin{pgfonlayer}{background}
	  \node (ss) [css, above = of 2, xshift = -8pt] {CSS$_{c_1}^{2}$};
  ...
  \begin{scope}[shift = {(0, -11)}]
	...
	\begin{pgfonlayer}{background}
	  \node (ss) [css, above = of 3, xshift = -8pt] {CSS$_{c_1}^{3}$};
