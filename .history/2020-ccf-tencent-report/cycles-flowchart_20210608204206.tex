...
\path (t1.south) to node [xshift=1em] {YES} (p2);
  \draw [*->,lcnorm] (t1.south) -- (p2);
\path (t2.south) to node [xshift=1em] {$y$} (t3);
  \draw [*->,lcnorm] (t2.south) -- (t3);
\path (t3.south) to node [xshift=1em] {$y$} (t4);
  \draw [*->,lcnorm] (t3.south) -- (t4);
\path (t5.south) to node [xshift=1em] {$y$} (t6);
  \draw [*->,lcfree] (t5.south) -- (t6);
\path (t6.south) to node [xshift=1em] {$y$} (t7);
...
\path (t1.east) to node [yshift=1em] {NO} (c1);
  \draw [o->,lcfree] (t1.east) -- (c1) |- (p4);
\path (t2.east) -| node [y near start, yshift=1em] {NO} (c1);
  \draw [o->,lcfree] (t2.east) -| (c1);
\path (t4.west) to node [yshift=-1em] {$k>0$} (c4);
  \draw [*->,lcnorm] (t4.west) -- (c4) |- (p3);
\path (t5.east) -| node [y near start, yshift=1em] {NO} (c6);
  \draw [o->,lcfree] (t5.east) -| (c6);
\path (t6.east) to node [yshift=1em] {NO} (c6);
