...
\begin{tikzpicture}[scale=1,    every axis/.style={
	...
	\begin{axis}[legend style={draw=none,at={(1, 0.7)}, anchor=west},axis on top]
		...
		\addplot[color=blue, pattern color=blue, pattern=north east lines] table [x expr=\coordindex, y=mini_check, col sep=comma] {../data/ser-e2e-keys-gpu.csv};
		\addplot[color=blue, pattern color=blue, pattern=crosshatch dots] table [x expr=\coordindex, y=cobra_check, col sep=comma] {../data/ser-e2e-keys-gpu.csv};
	\end{axis}
\end{tikzpicture}
