...
\begin{tikzpicture}[scale=1]
	\begin{axis}[
		...
		\addplot[color=blue,mark=square,mark size=3pt] table [x=sessions, y=polysi, col sep=comma] {./data/si-checker-sessions.csv};
		\addplot[color=red,mark=triangle,mark size=3pt] table [x=sessions, y=mini, col sep=comma] {./data/si-checker-sessions.csv};
