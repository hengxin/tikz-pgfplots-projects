...
\tikzset{
  ...
  \node (p2-deq2) [deq-op, right = 3.2cm of p2] {\texttt{Deq/2}};
  \node (p2-deq2') [deq-op, right = 1.3cm of p2-deq2] {\texttt{Deq/2}};

  \draw [po] (p1-enq1) to (p1-enq2);
  \draw [po] (p2-deq2) to (p2-deq2');

  \draw [vis] (p1-enq2) to (p2-deq2);
  \draw [vis] (p1-enq1) to (p2-deq2');
