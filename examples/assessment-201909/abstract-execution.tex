...
\tikzset{
  ...
  po/.style = {->, very thick}, 
  vis/.style = {->, shorten >= 3pt, very thick, dashed, red},
  rb/.style = {->, shorten >= 3pt, very thick, dotted, blue}
} 
  ...
  \draw [vis] (p2-enq2) to node [sloped, above, font = \LARGE] {$vis$} (p1-deq2);
  \draw [rb] (p2-enq2) to node [left, font = \LARGE] {$ar$} (p1-enq1);
\end{tikzpicture}   
\end{document}
