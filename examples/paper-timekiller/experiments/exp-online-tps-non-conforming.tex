...
\begin{document}
	\begin{tikzpicture}[]
		\begin{axis}[
			...
			\addplot[color=purple!50!blue,mark=square*,mark size=1.5pt] table [x=time, y=aion, col sep=comma] {./data/tps-non-conforming-no-gc.csv};
			\addplot[color=blue,mark=triangle*,mark size=1.5pt] table [x=time, y=aion, col sep=comma] {./data/tps-non-conforming-checking-gc.csv};
			\addplot[color=cyan,mark=*,mark size=1.5pt] table [x=time, y=aion, col sep=comma] {./data/tps-non-conforming-full-gc.csv};
