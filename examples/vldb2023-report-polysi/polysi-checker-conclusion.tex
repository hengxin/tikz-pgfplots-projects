...
\begin{tikzpicture}[
  ...
  every label/.style = {font = \normalsize}]
	...
	\node[above = 0.30cm of polysi, blue] (sound) {\it Sound};
	\node[below = 0.30cm of polysi, blue] (complete) {\it Complete};
	\node[right = 0.30cm of polysi, blue] (efficient) {\it Efficient};
	\node[below = 0.00cm of unsat, blue] (informative) {\it Informative};

	\node[draw, below right = 2.00cm and 0.30cm of polysi.south, fill = brown!50, inner sep = 5pt, align = center]
	  (monosat) {MonoSAT \\ Solving};
	\node[draw, below left = 2.00cm and 0.30cm of polysi.south, fill = brown!50, inner sep = 5pt, align = center]
