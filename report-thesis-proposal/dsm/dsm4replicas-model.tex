...
\newcommand{\mcs}[2]{\node (#1) [rectangle split,  rectangle split parts = 2, 
  rectangle split part fill = {lightgray, white}, draw, text width = 2.5cm, align = center] at (#2) 
  {Replica $r_{#1}$: \nodepart{two} DSM algorithm};}
