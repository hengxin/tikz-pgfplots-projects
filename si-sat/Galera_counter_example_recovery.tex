...
\begin{document}
  \begin{tikzpicture}[model/.style = {draw, minimum size = 15pt},
    ...
    \node[model, left = of 15, label = above : {$\T: (1, 4)$}, fill=green!20] (14) {$\writeevent(0,4)$};
    ...
    \draw[dashed, <-, thick, blue, sloped] (15.195) to node[]{$\WW$} (213.10);
    
    \draw[dashed, ->, thick, red, bend right = 45, sloped] (213.-15) to node[above] {$\RW$} (15.230);
    
    \draw[dashed, <-, thick, red, sloped] (213.-10) to node[]{$\WW$} (15.205);
