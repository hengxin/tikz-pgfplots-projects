...
\begin{document}
\begin{tikzpicture}[node distance = 0.0cm and 0.3cm, 
  ...
  \digraph{c1-1}{0.25}{label = {above : ${\scriptstyle s2ss[c_1]}$}}
  \digraph{c2-1}{0.25}{right = 10pt of c1-1, 
    label = {above : ${\scriptstyle s2ss[c_2]}$}}
  \digraph{c3-1}{0.25}{right = 15pt of c2-1, 
  ...
  % \node (c34) [below = of c33, 
  %   label = {[yshift = -5pt, size] above : \fbox{$3: \ins{a}{1}$}}] 
  % {\includegraphics[scale = 0.2]{xjupiter-c3-4}};

  % \node [bg, fit = (c1-4) (c3-4), label = {below : {\scriptsize Server}}] {};
