...
\begin{tikzpicture}[node distance = 0.0cm and 1.1cm, 
  ...
  bg/.style = {rectangle, draw, very thick, inner sep = 1pt},
  size/.style = {scale = 0.40}]
  \digraph{c1-0}{0.3}{label = {above : $s2ss[c_1]$}}
  \digraph{c2-0}{0.3}{right = of c1-0, label = {above : $s2ss[c_2]$}}
  \digraph{c3-0}{0.3}{right = of c2-0, label = {above : $s2ss[c_3]$}}
  \node (c30) [right = 1.8cm of c3-0, label = {above : $c2ss[c_3]$}] 
  ...
  \node [bg, fit = (c1-0) (c1-4) (c3-0) (c3-4), label = {below : Server}] {};
  \node [bg, fit = (c30) (c34), label = {below : Client $c_3$}] {};
\end{tikzpicture}
\end{document}