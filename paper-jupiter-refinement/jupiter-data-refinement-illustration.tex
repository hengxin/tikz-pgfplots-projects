...
\begin{tikzpicture}[bg/.style = {rectangle, draw, very thick}, node distance = 0.0cm,
  ...
  % absjupiter-c3-4
  \node (absj) [on chain] {\includegraphics[scale = 1.50]{absjupiter-c3-set}};
  % cjupiter-c3-4
  \node (cj) [on chain] {\includegraphics[scale = 1.00]{cjupiter-c3-nary-digraph}};
  % xjupiter-c3-4
  \node (xj) [on chain] {\includegraphics[scale = 1.00]{xjupiter-c3-2d-digraph}};
  % ajupiter-c3-4
  \node (aj) [on chain] {\includegraphics[scale = 1.50]{ajupiter-c3-buffer}};
  ...
  \draw [refine = {bend left = 10}] (cj.north) to node [below, font = \Huge, align = center] 
