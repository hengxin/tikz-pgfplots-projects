...
\begin{tikzpicture}[
  ...
  \draw[send] ($(r1)!0.20!(r1bot)$) node[op, left] (ins) {$o_1$ \\ $\ins{1}{x}$} 
    to ($(r2)!0.65!(r2bot)$) node[op, right] () {$o_1'$ \\ $\ins{1}{x}$};
  \draw[send, red, thick] ($(r2)!0.20!(r2bot)$) node[op, red, right] (del) {$o_2$ \\ $\del{2}$} 
    to ($(r1)!0.65!(r1bot)$) node[op, red, left] () {$o_2'$ \\ $\del{3}$};

  \node (r11) [list] at ($(r1)!0.40!(r1bot)$) {$xab$};
  \node (r12) [blue, list] at ($(r1)!0.85!(r1bot)$) {$xa$};

  \node (r21) [list] at ($(r2)!0.40!(r2bot)$) {$a$};
  \node (r22) [blue, list] at ($(r2)!0.85!(r2bot)$) {$xa$};
